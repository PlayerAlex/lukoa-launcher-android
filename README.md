...
- 诊断日志导出，方便排查问题
- 常见故障修复、Node.js 内存设置和聊天记录上传限制调整
...
你可以把代码用于个人学习、研究、非商业使用，也可以修改、制作衍生版本并在遵守许可证的前提下分发。

不允许把本项目或其修改版用于商业用途。分发源码或修改版时，必须同时保留本许可证文本或许可证链接。

仓库所使用的第三方依赖、Gradle Wrapper 和其他第三方组件仍分别遵循它们自己的许可证，本许可证不会替代这些第三方条款。
